...
sleep 0.5
echo -e $yellow
figlet -f big "SK WEB HACK"

echo -e "                   $g"SK"$r"BROTHERS"$w"SK"" 
echo -e "$a              # # # # # # # # # # # #"
echo -e "$a              #$G                     $o$a#"
echo -e "$a              #$G    $r"SK-WEB HACK  V3.2"$a   $o$a#"
echo -e "$a              #$G                     $o$a#"
echo -e "$a              # # # # # # # # # # # #"
echo
echo -e "  $G1$w Welcome to This Tool For Penetration Testing $o" 
echo -e $o"$green               Made by$yellow SAHADAT-KHAN "$o
echo -e " $g          Developers Team :  SK BROTHERS "
echo " "
echo -e "              $red Press ENTER to Continue"
echo -e $yellow
echo -n -e "[SK-WEB HACK]~#:"
sleep 2
read tmp
echo -e " "
...
CREDITS GOES TO$g SK$yellow"@"$green"SAHADAT-KHAN"$yellow from $g"SK"$r"BROTHERS"$w"DZ"$r (o_O)$reset"
echo
...
echo -n "[EasY_HaCk]~#:"
read tmp4
echo -e "$w My Facebook Team> $yellow https://www.facebook.com/groups/1126228364780841/?ref=share"
...
sleep 0.1
clear
echo "EXIT SK BROTHERS T..................\ "
sleep 0.1
clear
echo "EXIT SK BROTHERS TO................./ "
sleep 0.1
clear
echo "EXIT SK BROTHERS TOO................\ "
sleep 0.1
clear
echo "EXIT SK BROTHERS TOOL.............../ "
sleep 0.1
clear
echo "EXIT SK BROTHERS TOOL...............\ "
sleep 0.1
